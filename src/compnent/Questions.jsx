...
const Questions = () => {
  const questionsAns = [
    ...
    {
      question: "Is Netflex goods for kids ?",
      answer:
  ...
  return (
    <div className="px-32 py-10 mb-12 h-190">
      <div className="text-2xl font-bold mb-4">Frequently Asked Questions</div>

      <Accordion
        transitionDuration={500}
        classNames={{
          item: "!border-none !bg-[#2D2D2D] mb-2 ",
          control: "!bg-[#2D2D2D] hover:!bg-[#2D2D2D] text-white !p-5 px-10",
          label:
            "text-2xl !flex !justify-between items-center transition-colors w-full !text-white !bg-[#2D2D2D]",
          chevron:
            "text-5xl !text-white font-light transition-transform duration-500 data-[rotate]:rotate-45",
          panel: "!bg-[#2D2D2D] mt-1",
          content: "text-xl !px-8",
        }}
        chevron={<span>+</span>}
      >
